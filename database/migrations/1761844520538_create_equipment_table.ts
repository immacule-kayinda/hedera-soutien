...
export default class extends BaseSchema {
  ...
  async up() {
    this.schema.createTable(this.tableName, (table) => {
      ...
      table.integer('nft_id').unsigned().nullable().references('id').inTable('nfts').onDelete('SET NULL')
      ...
      table.integer('current_owner_id').unsigned().nullable().references('id').inTable('users').onDelete('SET NULL')
