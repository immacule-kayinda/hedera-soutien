    ...
    <footer className="border-t bg-card mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Plateforme solidaire connectant personnes handicapées et donateurs
              avec transparence blockchain.
            </p>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>
                <Link
                  href="/transparency"
                  className="hover-elevate inline-block rounded px-1 py-0.5"
                  data-testid="link-footer-transparency"
                >
                  Transparence
                </Link>
              </li>
        ...
        <div className="mt-8 pt-8 border-t text-center text-sm text-muted-foreground">
          <p>
            © 2025 HandiHelp. Tous droits réservés. Propulsé par Hedera
            Hashgraph.
          </p>
        </div>
      </div>
